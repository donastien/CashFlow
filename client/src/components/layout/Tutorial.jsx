...
const Tutorial = () => {
  return (
    <section className='container-fluid fontMontserrat'>
      <div>
        <div className='row'>
          <div className='col-sm text-light text-center h1 mt-5'>
            Welcome to CashFlow.
          </div>
        </div>
        <div className='row'>
        ...
        <div id='spoilerEN' className='collapse'>
          <div className='row'>
            <div className='col-sm-3 text-light text-center h5 mt-5'></div>
            <div className='col-sm-6 text-light text-center h5 mt-5'>
          ...
          <div className='row'>
            <div className='col-sm text-light text-center h5 mt-5'>
          ...
          <div className='row'>
            <div className='col-sm mt-1 text-center '>
              <img
                src={dashboard}
                className='rounded border w-75 mx-auto d-block'
                alt='dashboard'
              />
            </div>
          </div>
          <div className='row'>
            <div className='col-sm-6 text-light text-center h5 mt-5'>
              ...
              <img
                src={addmonth}
                className='rounded w-75 mx-auto d-block mt-3'
                alt='addmonth'
              />
            </div>
            <div className='col-sm-6 text-light text-center h5 mt-5'>
              ...
              <img
                src={month}
                className='rounded w-75 mx-auto d-block mt-5'
                alt='month'
              />
            </div>
          </div>
          ...
          <div className='row'>
            <div className='col-sm-3 text-light text-center h5 mt-5'></div>
            <div className='col-sm-6 text-light text-center h2 mt-5 mb-5'>
